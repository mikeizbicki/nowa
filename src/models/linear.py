...
def inference(images,datainfo):
    x_images=tf.reshape(images,[100,datainfo.IMAGE_SIZE,datainfo.IMAGE_SIZE,datainfo.IMAGE_COLORS])
    W = tf.Variable(tf.zeros([datainfo.IMAGE_SIZE,datainfo.IMAGE_SIZE,datainfo.IMAGE_COLORS,10]))
