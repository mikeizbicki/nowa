...
def training_data(FLAGS):
    print('constructing training input for ptb')
    datadir=os.path.join(FLAGS.input_data_dir,FLAGS.dataset)
    train,valid,test,_=ptb_raw_data(datadir)
    x,y=ptb_producer(train,FLAGS.batch_size,0)
    return x,y
...
if __name__ == '__main__':
    train,valid,test,_=ptb_raw_data('data/ptb')
    x,y=ptb_producer(train,100,0)
    print(x)
    #print(valid)
